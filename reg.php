...
$errors =array('email' => '', 'fullname' => '', 'password'=> '', 'confirm_password' => '', 'errors' => '');
if(isset($_POST['submit'])){
    ...
    if (empty($_POST['fullname'])) {
        ...
        $errors['fullname'] = "Firstname can only contain letters, numbers, and underscores.";
    } else {
                                    ...
                                    <div class="card-body" style="border-radius: 10px;">
                                        ...
                                        <form method="post" action="" >
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" name="fullname" id="inputFirstName" style="border-radius: 10px;" type="text" placeholder="Enter your first name" />
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control"  name="confirm_password" style="border-radius: 10px;" id="inputPasswordConfirm" type="password" placeholder="Confirm password" />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control"  name="phone" style="border-radius: 10px;" id="inputPasswordConfirm" type="text" placeholder="Confirm number" />
